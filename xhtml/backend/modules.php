...
return [
    'classes' => [
        ...
        'fields' => [
            ...
            'timeslots' => ['label' => 'Default Time Slots (comma separated)', 'type' => 'text', 'required' => false],
            'tiers' => ['label' => 'Program Tiers (comma separated)', 'type' => 'text', 'required' => false],
        ],
    ],
    'events' => [
        'table' => 'events',
    ...
    'gallery' => [
        ...
        'fields' => [
            ...
            'description' => ['label' => 'Description', 'type' => 'textarea', 'required' => false],
            'video_path' => ['label' => 'Video File', 'type' => 'file', 'required' => false],
            'image_path' => ['label' => 'Image', 'type' => 'file', 'required' => false],
        ],
    ],
    'blogs' => [
